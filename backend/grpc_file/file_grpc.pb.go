...
type FileServiceClient interface {
	GetAllFiles(ctx context.Context, in *GetFileByUser, opts ...grpc.CallOption) (*FileList, error)
}
...
func (c *fileServiceClient) GetAllFiles(ctx context.Context, in *GetFileByUser, opts ...grpc.CallOption) (*FileList, error) {
...
type FileServiceServer interface {
	GetAllFiles(context.Context, *GetFileByUser) (*FileList, error)
...
func (UnimplementedFileServiceServer) GetAllFiles(context.Context, *GetFileByUser) (*FileList, error) {
...
func _FileService_GetAllFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileServiceServer).GetAllFiles(ctx, req.(*GetFileByUser))
	}
