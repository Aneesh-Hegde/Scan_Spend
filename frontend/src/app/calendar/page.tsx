...
const getIncomes = async (): Promise<typed_income[]> => {
  ...
  return children({ transactions, loading, errors });
};

// Main FinancialCalendar component
const CalendarContent: React.FC = () => {
  const [currentDate, setCurrentDate] = useState<Date>(new Date(2025, 4, 9)); // Fixed date for consistency
